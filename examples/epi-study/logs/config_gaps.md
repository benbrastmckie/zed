...
> Snapshot from task 20 (Ketamine-Assisted Therapy Test RCT). This file
> documents the environment gaps observed when producing this demo and is
> preserved here unchanged so newcomers see the same caveats.
