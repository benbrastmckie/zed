...
Core reference documentation for this Zed configuration on macOS: how to install it, what keys to press, and what every setting means. Start here if you are setting up the editor for the first time, or come back when you want to look up a shortcut or tweak a configuration value.
...
2. **[keybindings.md](keybindings.md)** — learn the shortcuts you will use every day
3. **[settings.md](settings.md)** — understand and customize the configuration
