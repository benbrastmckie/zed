...
**Note**: For slides tasks, `/plan` routes to `skill-slides` which runs an interactive 5-stage design review (narrative arc, per-slide feedback, visual layout) before producing the slide plan.
