...
/plan 42              # interactive 5-stage slide design review (skill-slides)
/implement 42         # generate the slide deck
```

**Note**: For slides tasks, `/plan` routes to `skill-slides` rather than the generic planner. This runs an interactive design review covering narrative arc, per-slide content, and visual layout before producing the slide plan.
