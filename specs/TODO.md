...
- **Summary**: [01_python-r-setup-summary.md](019_python_and_r_setup_guides/summaries/01_python-r-setup-summary.md)
...
- **Summary**: [01_beginner-friendly-install-summary.md](015_improve_installation_docs_beginner_friendly/summaries/01_beginner-friendly-install-summary.md)
...
- **Summary**: Standardized all docs/ README files with consistent structure, cross-links, and correct keyboard shortcuts; rewrote root README as Zed + Claude Code for epidemiology/medical research; removed all Neovim and NixOS references from documentation scope.
